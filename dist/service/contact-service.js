...
class ContactService {
    ...
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_1.Validation.validate(contact_validation_1.ContactValidation.UPDATE, request); // Validasi request
            yield this.checkContactMustExists(user.username, updateRequest.id); // Cek pastikan contact nya harus ada
            // Update ke Database
    ...
    static delete(user, id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.checkContactMustExists(user.username, id); // Cek pastikan contact nya harus ada
